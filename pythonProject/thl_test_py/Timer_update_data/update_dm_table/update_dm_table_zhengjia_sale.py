...
# 导入SQL字典
from thl_test_py.arguments_sum.update_sql_desc_zhengjia_sale import zhengjia_sale_update


def update_zhengjia_sale(db_dict):
    """
    日数据更新主函数。
    ...
    # 二、销售数据更新部分：
    sql_dict_overwrite(target_db, zhengjia_sale_update)

    target_db.close_conn()


if __name__ == "__main__":
    update_zhengjia_sale(thltest_db_info)
    sleep(5)
    update_zhengjia_sale(thlprod_db_info)
else:
    pass
